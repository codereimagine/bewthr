...
const EMPTY: VisualViewportState = { height: 0, offsetTop: 0 }
...
// Safari and Android Chrome. CSS units (vh, dvh, svh) do not account for
// the keyboard since it's an OS-level overlay; this hook bridges the gap so
// React components can resize themselves to fit the available space.
//
// Returns {0, 0} when the API is unavailable; consumers should treat that
// as "fall back to CSS-driven sizing."
